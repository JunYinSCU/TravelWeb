...
public class YoukeController {
	...
	@IgnoreAuth
	@RequestMapping(value = "/check_ban")
	public R check_ban(String username, String password, String captcha, HttpServletRequest request) {
		int isBanned = youkeService.isBanned(new EntityWrapper<YoukeEntity>().eq("youkezhanghao", username));
	...
	public R forget(String username, String newpassword, String captcha, HttpServletRequest request) {
		System.out.println(newpassword);
		YoukeEntity user = youkeService.selectOne(new EntityWrapper<YoukeEntity>().eq("youkezhanghao", username));
		if(user==null || !user.getMima().equals(newpassword)) {
			return R.error("身份证或邮箱不正确");
		}
