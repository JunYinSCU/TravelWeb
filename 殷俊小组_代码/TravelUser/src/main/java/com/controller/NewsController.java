...
public class NewsController {
    @Autowired
    private NewsService lvyouxianluService;
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params, NewsEntity lvyouxianlu,
                  HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("youke")) {
			lvyouxianlu.setYoukezhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params, NewsEntity lvyouxianlu,
                  HttpServletRequest request){
        EntityWrapper<NewsEntity> ew = new EntityWrapper<NewsEntity>();
		PageUtils page = lvyouxianluService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, lvyouxianlu), params), params));
        return R.ok().put("data", page);
    ...
    public R list( NewsEntity lvyouxianlu){
       	EntityWrapper<NewsEntity> ew = new EntityWrapper<NewsEntity>();
    ...
    public R query(NewsEntity lvyouxianlu){
        EntityWrapper<NewsEntity> ew = new EntityWrapper<NewsEntity>();
 		ew.allEq(MPUtil.allEQMapPre( lvyouxianlu, "lvyouxianlu")); 
		NewsView lvyouxianluView =  lvyouxianluService.selectView(ew);
    ...
    public R info(@PathVariable("id") Long id){
        NewsEntity lvyouxianlu = lvyouxianluService.selectById(id);
     ...
     */
    @RequestMapping("/save")
    public R save(@RequestBody NewsEntity lvyouxianlu, HttpServletRequest request){
     ...
     */
    @RequestMapping("/add")
    public R add(@RequestBody NewsEntity lvyouxianlu, HttpServletRequest request){
    	lvyouxianlu.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(lvyouxianlu);
        lvyouxianluService.insert(lvyouxianlu);
        return R.ok();
    ...
    public R update(@RequestBody NewsEntity lvyouxianlu, HttpServletRequest request){
        //ValidatorUtils.validateEntity(lvyouxianlu);
